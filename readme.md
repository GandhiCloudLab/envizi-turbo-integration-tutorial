...
Here is the sample Group and Location [file](./files2/Accounts.csv)
...
Here is the sample Accounts [file](./files2/Locations.csv)
...
#### Data Type
3. It shows the below `data type`
```
    Energy Consumption
    Active Hosts
    Active VMs
...
1. Shows sub group called `ONPREM-DataCenter`
